...
public Result<Recommended> venuesExplore(String ll) throws FoursquareApiException {
	// TODO Auto-generated method stub
	try {
	      ApiRequestResponse response = doApiRequest(Method.GET, "venues/explore", isAuthenticated(), "ll", ll);
	      Recommended result = null;
